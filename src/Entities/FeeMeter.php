...
class FeeMeter {
        ...
        Distance $distance2)
    {
        ...
        $this->fee->increment($incrementCount * self::NORMAL_ADD_FEE, $this->kawaseBairitu($country));
    }
    ...
    private function calcSlowFee(Time $time, Time $time2)
    {
        ...
        $this->fee->increment($incrementCount * self::SLOW_ADD_FEE, $this->kawaseBairitu($country));
    }
    ...
    public function kawaseBairitu($country)
    {
        return self::BAIRITSU[$country];
    }
}
